...
const ROLES_HIERARCHY = ["user", "editor", "admin"] as const;
type Role = (typeof ROLES_HIERARCHY)[number];

export const validateRole = (role: string, requiredRole: Role): boolean => {
  const userRoleIndex = ROLES_HIERARCHY.indexOf(role.toLowerCase() as Role);
...
export const validateRegisterRequest = (
  ...
  return (
    ...
    ["user", "editor", "admin"].includes(registerData.role) &&
...
export const validateRegisterCustomerRequest = (
  ...
  return (
    ...
    validateName(customerData.userName) &&
